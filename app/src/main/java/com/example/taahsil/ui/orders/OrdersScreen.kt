...
fun OrdersScreen(
    ...
    // Show success snackbar after order is placed
                ...
                item {
                    BentoCard(modifier = Modifier.fillMaxWidth()) {
                        Row(
                            ...
                            Text(
                                text = "₹${String.format("%,.0f", viewModel.getCartTotal())}",
                        ...
                        Button(
                            onClick = { viewModel.placeOrder("CUST-001") },
                            modifier = Modifier
                                .fillMaxWidth()
                                .height(48.dp),
                            ...
                            Spacer(modifier = Modifier.width(8.dp))
                            Text("Place Order — ₹${String.format("%,.0f", viewModel.getCartTotal())}", fontWeight = FontWeight.SemiBold)
                        }

                        // Error state
                        state.error?.let { err ->
                            Spacer(modifier = Modifier.height(8.dp))
                            Text(err, color = ErrorRed, style = MaterialTheme.typography.labelMedium)
                        }
                    }
                }
            } else {
                ...
                item {
                    BentoCard(modifier = Modifier.fillMaxWidth()) {
                        Column(
                            ...
                            Icon(Icons.Rounded.ShoppingCart, contentDescription = null, tint = GrayText, modifier = Modifier.size(48.dp))
                            Spacer(modifier = Modifier.height(8.dp))
                            Text("Your cart is empty", color = GrayText, style = MaterialTheme.typography.bodyMedium)
                            Spacer(modifier = Modifier.height(12.dp))
                            OutlinedButton(
